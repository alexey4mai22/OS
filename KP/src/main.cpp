...
int main()
{
    ...
    void* p1 = a1.fbmalloc(size100);
    cout << "p1 = " << p1 << endl << endl;
    a1.fb_print_info();

    void* p2 = a1.fbmalloc(size100);
    cout << "p2 = " << p2 << endl << endl;
    a1.fb_print_info();

    void* p3 = a1.fbmalloc(size100);
    cout << "p3 = " << p3 << endl << endl;
    a1.fb_print_info();

    a1.fbfree(p2, size100);
    cout << "p2 freed" << endl << endl;
    a1.fb_print_info();

    a1.fbfree(p1, size100);
    cout << "p1 freed" << endl << endl;
    a1.fb_print_info();

    a1.fbfree(p3, size100);
    ...
    void* p4 = a2.mkmalloc(size100);
    cout << "p4 = " << p4 << endl << endl;
    a2.mk_print_info();

    void* p5 = a2.mkmalloc(size100);
    cout << "p5 = " << p5 << endl << endl;
    a2.mk_print_info();

    void* p6 = a2.mkmalloc(size100);
    cout << "p6 = " << p6 << endl << endl;
    a2.mk_print_info();

    void* p7 = a2.mkmalloc(size100);
